...
const Mutation = {
  ...
  async deletePost(parent, args, { prisma, request }, info) {
    ...
    if (!postExists) throw new Error('unable to find post to delete');
  ...
  async updatePost(parent, args, { prisma, request }, info) {
    ...
    if (!postExists) throw new Error('unable to find post to update');
    ...
    // delete all comments when unpublish the post
